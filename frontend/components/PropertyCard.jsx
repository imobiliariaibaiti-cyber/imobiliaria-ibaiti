      ...
      <div className="space-y-3 p-5">
        ...
        <div className="flex gap-2 pt-2 flex-col sm:flex-row">
          <Link
            ...
            className="flex-1 rounded-xl bg-brand-700 px-4 py-2 text-center text-sm font-semibold text-white w-full"
          >
            Ver Detalhes
          </Link>
          <a
            href={whatsapp}
            target="_blank"
            className="rounded-xl border border-brand-700 px-4 py-2 text-sm font-semibold text-brand-700 text-center w-full"
            rel="noreferrer"
          >
            Saber Mais
          </a>
